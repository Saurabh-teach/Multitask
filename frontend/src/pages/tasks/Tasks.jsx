                  ...
                  <>
                    ...
                    <div className="absolute top-12 right-0 w-72 bg-white rounded-2xl shadow-2xl border border-gray-100 p-2 z-50">
                      ...
                      <div className="px-3 py-3 mb-1">
                        ...
                        <div className="flex rounded-xl border border-gray-100 overflow-hidden">
                          <button
                            ...
                            className={`flex-1 py-2.5 text-xs font-black uppercase flex items-center justify-center gap-2 transition-all ${
                              viewMode === 'kanban' ? 'bg-[#0052CC] text-white' : 'text-gray-500 hover:bg-gray-50'
                            }`}
                          >
                          ...
                          <button
                            ...
                            className={`flex-1 py-2.5 text-xs font-black uppercase flex items-center justify-center gap-2 transition-all ${
                              viewMode === 'list' ? 'bg-[#0052CC] text-white' : 'text-gray-500 hover:bg-gray-50'
                            }`}
                          >
                            <List size={14} /> List
                          </button>
                      ...
                      <button
                        ...
                        className={`w-full text-left px-4 py-3 text-sm font-bold rounded-xl transition-all flex items-center justify-between ${
                          isFocusModeOn ? 'bg-amber-50 text-amber-700' : 'text-gray-700 hover:bg-amber-50 hover:text-amber-600'
                        }`}
                      >
                    ...
                    <div className="flex items-center justify-between pt-3 border-t border-[#F4F5F7]">
                      ...
                      <div className="flex flex-col items-end gap-1">
                        ...
                        <select 
                          ...
                          className="text-[10px] font-bold text-[#172B4D] bg-white border border-[#DFE1E6] hover:border-[#4C9AFF] px-2 py-1 rounded shadow-sm outline-none cursor-pointer transition-all appearance-none"
                        >
                      ...
                      <div className="space-y-4">
                        <div className="space-y-1">
                          ...
                          <select 
                            ...
                            className="w-full bg-[#EBECF0] hover:bg-[#DFE1E6] text-sm font-bold text-[#42526E] rounded px-3 py-2 uppercase outline-none transition-all cursor-pointer"
                          >
                            {columns.map(c => <option key={c.id} value={c.id}>{c.title}</option>)}
                          </select>
                        </div>
