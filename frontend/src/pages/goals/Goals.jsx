...
const Goals = () => {
  ...
  const handleDeleteGoal = async (e, goalId) => {
    e.stopPropagation();
    if (!window.confirm("Are you sure you want to delete this epic? All associated tasks will be orphaned.")) return;
        ...
        <nav className="bg-white border-b border-gray-200 sticky top-0 z-40">
          <div className="px-10 py-5 flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl font-bold text-gray-900 brand-font tracking-tight">Strategic Epics</h1>
            </div>
        ...
        <div className="flex-1 overflow-y-auto p-10 space-y-8 animate-fade-in">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
             <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm flex items-center justify-between group hover:border-blue-200 transition-all">
                <div>
                   <p className="text-[11px] font-bold text-gray-400 uppercase tracking-widest mb-1">Total Epics</p>
          ...
          {loading ? (
            ...
            <div className="card-premium py-24 text-center border-dashed border-2">
              ...
              <h3 className="text-2xl font-bold text-gray-900 brand-font mb-3">No Epics Found</h3>
              <p className="text-gray-500 mb-10 max-w-sm mx-auto font-medium">Capture your long-term goals as Epics to start tracking progress effectively across your team.</p>
              <button 
                onClick={() => navigate('/goals/create')}
